...
'''
unimodal_smile_baal.py --batch_size=256 --beta1=0.8404890210165532 --beta2=0.8141970349352089 --corr_thr=0.85 --drop_correlated=no --gamma=0.6837069453050101 --learning_rate=0.4528057554883652 --minority_oversample=yes --model=ANN --momentum=0.28538622987932627 --num_epochs=76 --optimizer=AdamW --patience=7 --random_state=684 --scaling_method=StandardScaler --scheduler=step --seed=164 --step_size=23 --use_feature_scaling=yes --use_scheduler=no --weight_decay=0.06037799005249093
'''
@click.command()
...
@click.option("--learning_rate", default=0.4528057554883652, help="Learning rate for classifier")
@click.option("--random_state", default=684, help="Random state for classifier")
@click.option("--seed", default=164, help="Seed for random")
...
@click.option("--num_epochs", default=76)
...
@click.option("--beta1", default=0.8404890210165532)
@click.option("--beta2", default=0.8141970349352089)
@click.option("--weight_decay", default=0.06037799005249093)
@click.option("--momentum", default=0.28538622987932627)
...
@click.option("--gamma", default=0.6837069453050101)
