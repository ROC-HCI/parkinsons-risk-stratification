...
'''
unimodal_finger_baal.py --batch_size=64 --beta1=0.8445436908512619 --beta2=0.9839496691165646 --corr_thr=0.9 --drop_correlated=no --gamma=0.5205776395217697 --learning_rate=0.3967475591258265 --minority_oversample=yes --model=ShallowANN --momentum=0.6070539541636875 --num_epochs=87 --optimizer=SGD --patience=6 --random_state=3837 --scaling_method=StandardScaler --scheduler=step --seed=769 --step_size=43 --use_feature_scaling=yes --use_scheduler=yes --weight_decay=0.09522495108614808
'''
@click.command()
...
@click.option("--learning_rate", default=0.3967475591258265, help="Learning rate for classifier")
@click.option("--random_state", default=3837, help="Random state for classifier")
@click.option("--seed", default=769, help="Seed for random")
...
@click.option("--beta1", default=0.8445436908512619)
@click.option("--beta2", default=0.9839496691165646)
@click.option("--weight_decay", default=0.09522495108614808)
@click.option("--momentum", default=0.6070539541636875)
@click.option("--use_scheduler", default='yes', help="Options: yes, no")
@click.option("--scheduler", default='step', help="Options: step, reduce")
@click.option("--step_size", default=43)
@click.option("--gamma", default=0.5205776395217697)
