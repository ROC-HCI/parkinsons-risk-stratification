...
'''
unimodal_fox_baal.py --batch_size=128 --beta1=0.8394367462915501 --beta2=0.884639240806163 --corr_thr=0.8 --drop_correlated=yes --gamma=0.33787764601003073 --learning_rate=0.11128449140621435 --minority_oversample=yes --model=ANN --momentum=0.34539832033420004 --num_epochs=37 --optimizer=SGD --patience=7 --random_state=5096 --scaling_method=StandardScaler --scheduler=step --seed=481 --step_size=16 --use_feature_scaling=yes --use_scheduler=no --weight_decay=0.02414347420732582
'''
@click.command()
...
@click.option("--learning_rate", default=0.11128449140621435, help="Learning rate for classifier")
@click.option("--random_state", default=5096, help="Random state for classifier")
@click.option("--seed", default=481, help="Seed for random")
...
@click.option("--num_epochs", default=37)
...
@click.option("--beta1", default=0.8394367462915501)
@click.option("--beta2", default=0.884639240806163)
@click.option("--weight_decay", default=0.02414347420732582)
@click.option("--momentum", default=0.34539832033420004)
...
@click.option("--gamma", default=0.33787764601003073)
