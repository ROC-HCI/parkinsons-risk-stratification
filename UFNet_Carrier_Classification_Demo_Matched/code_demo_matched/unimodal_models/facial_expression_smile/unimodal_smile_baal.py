...
'''
unimodal_smile_baal.py --batch_size=512 --beta1=0.9103231877710296 --beta2=0.9479619440012998 --corr_thr=0.8 --drop_correlated=no --gamma=0.7378436665625764 --learning_rate=0.4395428404432807 --minority_oversample=yes --model=ANN --momentum=0.6280901702506705 --num_epochs=64 --optimizer=AdamW --patience=9 --random_state=2096 --scaling_method=StandardScaler --scheduler=step --seed=635 --step_size=17 --use_feature_scaling=yes --use_scheduler=no --weight_decay=0.03858124754390866
'''
...
@click.option("--learning_rate", default=0.4395428404432807, help="Learning rate for classifier")
@click.option("--random_state", default=2096, help="Random state for classifier")
@click.option("--seed", default=635, help="Seed for random")
...
@click.option("--beta1", default=0.9103231877710296)
@click.option("--beta2", default=0.9479619440012998)
@click.option("--weight_decay", default=0.03858124754390866)
@click.option("--momentum", default=0.6280901702506705)
...
@click.option("--gamma", default=0.7378436665625764)
